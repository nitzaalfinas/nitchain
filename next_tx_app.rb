...
block[:data] = {}
block[:data][:num] = 2
block[:data][:prevhash] = "000762b951668aed0c00ab95819457242654864beb09e14922d5d1d99d541043"
block[:data][:tcount] = 1
...
block[:data][:outputs][0][:balance] = 999900100
block[:data][:outputs][1] = {}
block[:data][:outputs][1][:address] = zz[:input][:to]
block[:data][:outputs][1][:balance] = 100000
